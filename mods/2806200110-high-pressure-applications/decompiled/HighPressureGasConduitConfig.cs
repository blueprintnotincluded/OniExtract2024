...
public class HighPressureGasConduitConfig : IBuildingConfig
{
	...
	public static string Effect = string.Concat("Carries a maximum of " + (float)SingletonOptions<HPA_ModSettings>.Instance.HPGas, "kg of ", UI.FormatAsLink("Gas", "ELEMENTS_GAS"), " with minimal change in ", UI.FormatAsLink("Temperature", "HEAT"), ".\n\nCan be run through wall and floor tile.");
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		string text = "HighPressureGasConduit";
		int num = 1;
		int num2 = 1;
		string text2 = "pressure_gas_pipe_kanim";
		int num3 = 10;
		float num4 = 30f;
		...
		val2.ObjectLayer = (ObjectLayer)12;
		val2.TileLayer = (ObjectLayer)13;
		val2.ReplacementLayer = (ObjectLayer)14;
		val2.AudioCategory = "Metal";
		val2.AudioSize = "small";
		val2.BaseTimeUntilRepair = 0f;
		val2.UtilityInputOffset = new CellOffset(0, 0);
		val2.UtilityOutputOffset = new CellOffset(0, 0);
		val2.SceneLayer = (SceneLayer)3;
		val2.isKAnimTile = true;
		val2.isUtility = true;
		val2.DragBuild = true;
		val2.ReplacementTags = new List<Tag>();
		val2.ReplacementTags.Add(GameTags.Vents);
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		val.connectionSource = (ConnectionSource)0;
