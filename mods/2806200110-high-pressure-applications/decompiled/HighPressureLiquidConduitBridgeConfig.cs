...
public class HighPressureLiquidConduitBridgeConfig : IBuildingConfig
{
	...
	private const ConduitType CONDUIT_TYPE = (ConduitType)2;
	...
	public override BuildingDef CreateBuildingDef()
	{
		...
		string text = "HighPressureLiquidConduitBridge";
		int num = 3;
		int num2 = 1;
		string text2 = "pressure_liquid_bridge_kanim";
		int num3 = 10;
		float num4 = 45f;
		...
		val2.ObjectLayer = (ObjectLayer)19;
		val2.SceneLayer = (SceneLayer)6;
		val2.InputConduitType = (ConduitType)2;
		val2.OutputConduitType = (ConduitType)2;
		...
		GeneratedBuildings.RegisterWithOverlay(OverlayScreen.LiquidVentIDs, "HighPressureLiquidConduitBridge");
		return val2;
	}
