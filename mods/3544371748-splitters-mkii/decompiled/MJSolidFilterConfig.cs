...
public class MJSolidFilterConfig : IBuildingConfig
{
	public static string ID = "MJSplitterMKIISolid";

	public static string DisplayName = LocString.op_Implicit(MJSplittersMKIIStrings.UI.SOLID_DISPLAY_NAME);
	...
	protected ConduitType ConduitType = (ConduitType)3;

	protected List<Tag> TagList = new List<Tag>(STORAGEFILTERS.SOLID_TRANSFER_ARM_CONVEYABLE);

	protected HashSet<Tag> OverlayTags = OverlayScreen.SolidConveyorIDs;

	protected ConduitPortInfo SecondaryPort = new ConduitPortInfo((ConduitType)3, new CellOffset(0, 0));

	protected HashedString ViewMode = SolidConveyor.ID;
