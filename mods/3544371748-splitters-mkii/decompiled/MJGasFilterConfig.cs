...
public class MJGasFilterConfig : IBuildingConfig
{
	public static string ID = "MJSplitterMKIIGas";

	public static string DisplayName = LocString.op_Implicit(MJSplittersMKIIStrings.UI.GAS_DISPLAY_NAME);
	...
	protected ConduitType ConduitType = (ConduitType)1;

	protected List<Tag> TagList = new List<Tag>(STORAGEFILTERS.GASES);

	protected HashSet<Tag> OverlayTags = OverlayScreen.GasVentIDs;

	protected ConduitPortInfo SecondaryPort = new ConduitPortInfo((ConduitType)1, new CellOffset(0, 0));

	protected HashedString ViewMode = GasConduits.ID;
